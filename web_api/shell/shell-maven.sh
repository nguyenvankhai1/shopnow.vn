...
start(){
    ...
    if [ $t1 -eq 0  ];
    then
#nohup	 java -cp :./lib/*:$grepParams vn.longth.controller.Webservice &
#nohup	 java -Xms512m -Xmx2048m -jar Alo1030WS-1.0.jar $grepParams &
#-Xms512m -Xmx2048m
  java -jar -Dspring.profiles.active=dev nghenhanvn-0.0.1-SNAPSHOT.jar $grepParams &
  # $runPath/run.sh &
