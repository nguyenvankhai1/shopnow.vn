    ...
    <client-only>
      <div v-if="open_add === 1">
        ...
        <div class="pt-16 pb-5">
          ...
          <div class="ml-14">
            <div class="font-weight-bold fs-16">URL thân thiện cho SEO</div>
          ...
          <div class="ml-12 d-flex">
            <div class="font-weight-bold fs-16 mt-1 pr-7">Combo du lịch</div>
            <v-switch
          ...
          <div class="ml-14">
            ...
            <div class="font-weight-bold fs-16">Mô tả ngắn</div>
            <v-row>
              <v-col cols="10" class="py-0">
                <v-text-field
                      ...
                      <div :key="`${idx}+${image}`">
                          ...
                          <v-hover v-slot="{ hover }">
                            ...
                            >
                              <v-expand-transition>
                                <div
                                  v-if="hover"
                                  class="d-flex transition-fast-in-fast-out fs-14 white v-card--reveal text-truncate black--text"
                                  style="height: 100%"
                                >
                                  <span
                                    class="text-truncate"
                        ...
                        <div v-else>
                          ...
                          >
                            ...
                            <div
                              class="pt-3 fs-14 pl-2 text-truncate"
                              style="max-width: 100px"
                            >
                              {{ image.tilte }}
                            </div>
          ...
          <div class="ml-12 d-flex mt-3">
            <div class="font-weight-bold fs-16 pt-1 pr-7">Khách sạn</div>
            <v-switch
          ...
          <div class="ml-14">
            ...
            <div class="mt-4">
              <v-row>
                <v-col cols="auto">
                  <div class="font-weight-bold fs-16">Sắp xếp</div>
                </v-col>
          ...
          <div class="ml-12 d-flex">
            <div class="font-weight-bold fs-16 pt-1 pr-7">Nhà hàng</div>
          ...
          <div class="ml-12 d-flex">
            <div class="font-weight-bold fs-16 pt-1 pr-7">Tour du lịch</div>
          ...
          <!-- // videos -->
          <div class="ml-12 d-flex">
            <div class="font-weight-bold fs-16 pt-1 pr-7">Videos</div>
                          ...
                          <v-hover v-slot="{ hover }">
                            ...
                            >
                              <v-expand-transition>
                                <div
                                  v-if="hover"
                                  class="d-flex transition-fast-in-fast-out fs-14 white v-card--reveal black--text"
                                  style="height: 100%"
                                >
                                  <span
                                    class="text-truncate"
...
export default {
  ...
  methods: {
    ...
    config_detail() {
      ...
      this.description_restaurant = this.data.homeConfigCur.restaurant_description
    ...
    config_insert() {
      ...
      this.$store
        .dispatch('quan_tri_trang_chu/config_insert', {
          ...
          video_thumbnail: this.select_choose === 1 ? this.img_thumbnail : null,
