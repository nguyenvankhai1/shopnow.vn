              ...
              <v-row class="ml-10">
                ...
                <v-col cols="auto">
                  ...
                  <div>
                    ...
                    <div
                      v-if="required_img_zoom_out_default"
              ...
              <v-row>
                ...
                <v-col cols="auto">
                  ...
                  <div>
                    ...
                    <div
                      v-if="required_img_avatar_default"
                      class="v-messages theme--light error--text mt-1"
                      role="alert"
                    >
                      <div class="v-messages__wrapper">
                ...
                <v-row class="ml-10">
                  ...
                  <v-col cols="auto">
                    <div>
                      ...
                      <div
                        v-if="required_img_zoom_out_promotion"
                        class="v-messages theme--light error--text mt-1"
                        role="alert"
                      >
                        <div class="v-messages__wrapper">
                ...
                <v-row>
                  ...
                  <v-col cols="auto">
                    <div>
                      ...
                      <div
                        v-if="required_img_avatar_promotion"
                        class="v-messages theme--light error--text mt-1"
                        role="alert"
                      >
                        <div class="v-messages__wrapper">
        ...
        .then((res) => {
          if (!res.error) {
            ...
            if (this.choose_form === 1) {
              ...
              this.tab1 = null
              this.tab2 = null
              this.status_evaluate_default =
                res.data.data.post.interested_status
              this.stauts_care_default = res.data.data.post.vote_status
              this.category_posts_default = res.data.data.post.category_post_ids.split(
                ','
              )
              ...
              this.status_evaluate_promotion =
                res.data.data.post.interested_status
              this.status_care_promotion = res.data.data.post.vote_status
              this.category_posts_promotion = res.data.data.post.category_post_ids.split(
                ','
              )
