        ...
        >
          <template #top>
            ...
            /> -->
              ...
              <v-spacer></v-spacer>
              <!-- <div class="font-weight-bold mr-6">Tự động duyệt Nhà cung cấp</div>
            <v-switch
              v-model="auto"
              color="#47bbff"
              class="mt-0"
...
export default {
  ...
  methods: {
    ...
    // get_status_auto() {
    //   this.$store.dispatch('nha_cung_cap/auto_browse_product').then((res) => {
    //     if (!res.error) {
    //       this.auto = res.data.data[0].enterprise_approval_status
    //     }
    //   })
    // },
    // change_status_auto() {
    //   this.$store
    //     .dispatch('nha_cung_cap/change_auto_browse_product', {
    //       status: this.auto,
    //     })
    //     .then((res) => {
    //       if (!res.error) {
    //         this.$showSuccess(
    //           this,
    //           'Thay đổi trạng thái tự động duyệt Nhà cung cấp thành công'
    //         )
    //       }
    //     })
    //     .finally(() => {
    ...
    //     this.$store
    //       .dispatch('nha_cung_cap/change_status', DATA)
    //       .then((res) => {
    //         if (!res.error) {
    //           this.$showSuccess(
    //             this,
