  ...
  methods: {
    ...
    getlist() {
      ...
      this.$store
        ...
        .then((response) => {
          if (!response.error) {
            this.items = response.data.data.commentGetLists
            ...
            const arr = {
              begin_idx: response.data.data.beginIdx,
              end_idx: response.data.data.endIdx,
              total_page: response.data.data.toralpage,
              total_record: response.data.data.totalRecord,
            }
            this.pageInfo = arr
            this.pageCount = arr.total_page
          }
        })
    },
    quest_deletes() {
