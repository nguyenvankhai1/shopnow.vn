    ...
    <v-container class="ml-6">
      <v-row class="my-10">
        ...
        <v-col cols="12" class="my-0">
          <div class="d-flex align-center">
            <div class="fs-14 font-weight-bold mr-10">Thêm vào Menu</div>
            <v-switch
              v-model="menu_add"
              color="#47bbff"
              class="ma-0"
        ...
        <v-col cols="12" class="pb-0">
          <div class="d-flex align-center">
            <div class="fs-16 font-weight-bold mr-10">Bản đồ</div>
            <v-switch
              v-model="map"
              class="ma-0"
              color="#47bbff"
        ...
        <v-col cols="12" class="mt-6">
          <div class="fs-18 text-uppercase font-weight-bold">Sản phẩm</div>
