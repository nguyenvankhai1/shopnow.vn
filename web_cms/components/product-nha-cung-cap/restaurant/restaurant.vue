...
import Suggestions from '~/components/product-nha-cung-cap/restaurant/suggestions/index'
import Services from '~/components/product-nha-cung-cap/restaurant/services/index'
...
export default {
  ...
  created() {
    ...
    this.$store
      .dispatch('nha_cung_cap_san_pham/restaurant_gen_sku')
      .then((res) => {
        if (!res.error) {
