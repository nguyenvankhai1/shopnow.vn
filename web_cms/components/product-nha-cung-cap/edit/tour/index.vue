  ...
  <div>
    <client-only>
      ...
      <v-tabs-items v-model="tabmenu" style="background-color: #f5f7fe">
        <v-tab-item>
          <div class="add-product-tour-info-1">
              ...
              <v-row class="mt-2 ml-10 mb-10">
                  ...
                  <v-tabs-items v-model="tab" style="background-color: #f5f7fe">
                    ...
                    >
                      <v-text-field
                        ...
                        :outlined="language.tour_msg.length !== 0"
                        :readonly="uncorrected"
                  ...
                  >
                    ...
                    >
                      <v-textarea
                        ...
                        :outlined="language.journeys_msg.length !== 0"
                        :readonly="uncorrected"
                ...
                <v-col class="py-0 d-flex" cols="11">
                  ...
                  <v-autocomplete
                    ...
                    :outlined="departure_msg.length !== 0"
                    :readonly="uncorrected"
                ...
                <v-col cols="11">
                  ...
                  >
                    ...
                    >
                      <!--                      <quill-editor-->
                      <!--                        ref="myTextEditor"-->
                      <!--                        v-model="language.introduce"-->
                      <!--                        :options="$store.state.product.editorOption"-->
                      <!--                        class="quill-editor pb-12"-->
                      <!--                        :disabled="uncorrected"-->
                      <!--                        @input="language.introduce_msg = []"-->
                      <!--                      />-->
                      <vue-editor
                        v-model="language.introduce"
                        :disabled="uncorrected"
                        use-custom-image-handler
                        @text-change="language.introduce_msg = []"
                      />
                      <div
                      ...
                      >
                        <v-tab-item>
                          ...
                          <vue-editor
                            ...
                            :disabled="uncorrected"
                            use-custom-image-handler
                            @text-change="language.service_msg = []"
                          />
                          <div
                        ...
                        <v-tab-item>
                          <!--                          <quill-editor-->
                          <!--                            ref="myTextEditor"-->
                          <!--                            v-model="language.service_no"-->
                          <!--                            :options="$store.state.product.editorOption"-->
                          <!--                            class="quill-editor pb-12"-->
                          <!--                            :disabled="uncorrected"-->
                          <!--                            @input="language.service_no_msg = []"-->
                          <!--                          />-->
                          <vue-editor
                            v-model="language.service_no"
                            :disabled="uncorrected"
                            use-custom-image-handler
                            @text-change="language.service_no_msg = []"
                          />
                          <div
                    ...
                    >
                      ...
                      >
                        <v-tab-item>
                          <!--                          <quill-editor-->
                          <!--                            ref="myTextEditor"-->
                          <!--                            v-model="language.regulations"-->
                          <!--                            :options="$store.state.product.editorOption"-->
                          <!--                            class="quill-editor pb-12"-->
                          <!--                            :disabled="uncorrected"-->
                          <!--                            @input="language.regulations_msg = []"-->
                          <!--                          />-->
                          <vue-editor
                            v-model="language.regulations"
                            :disabled="uncorrected"
                            use-custom-image-handler
                            @text-change="language.regulations_msg = []"
                          />
                          <div
                        ...
                        <v-tab-item>
                          <!--                          <quill-editor-->
                          <!--                            ref="myTextEditor"-->
                          <!--                            v-model="language.cancel_exchange"-->
                          <!--                            :options="$store.state.product.editorOption"-->
                          <!--                            class="quill-editor pb-12"-->
                          <!--                            :disabled="uncorrected"-->
                          <!--                            @input="language.cancel_exchange_msg = []"-->
                          <!--                          />-->
                          <vue-editor
                            v-model="language.cancel_exchange"
                            :disabled="uncorrected"
                            use-custom-image-handler
                            @text-change="language.cancel_exchange_msg = []"
                          />
                          <div
                        ...
                        <v-tab-item>
                          <!--                          <quill-editor-->
                          <!--                            ref="myTextEditor"-->
                          <!--                            v-model="language.note2"-->
                          <!--                            :options="$store.state.product.editorOption"-->
                          <!--                            class="quill-editor pb-12"-->
                          <!--                            :disabled="uncorrected"-->
                          <!--                            @input="language.note2_msg = []"-->
                          <!--                          />-->
                          <vue-editor
                            v-model="language.note2"
                            :disabled="uncorrected"
                            use-custom-image-handler
                            @text-change="language.note2_msg = []"
                          />
                          <div
    ...
    <yes-no-alert
      :open="open_save"
      alert-msg="Bạn chắc chắn muốn lưu thông tin đã được thay đổi không?"
...
import Suggestions from '~/components/product-nha-cung-cap/edit/tour/suggestions/index'
import Schedule from '~/components/product-nha-cung-cap/edit/tour/schedule/index'
import DepartureSchedule from '~/components/product-nha-cung-cap/edit/tour/DepartureSchedule/index'
  ...
  methods: {
    ...
    set_data() {
      ...
      for (let i = 0; i < this.data.tourThumbnails.length; i++) {
        ...
        //   url: this.data.tourThumbnails[i].url,
        //   type: 1,
        // })
      }
      ...
      // const suggestions = []
      // for (let i = 0; i < this.data.tourSuggestions.length; i++) {
      //   listsuggestions.push({
      //     hotel_id: this.data.tourSuggestions[i].restaurant_id,
      //     id: this.data.tourSuggestions[i].id,
      //     name: this.data.tourSuggestions[i].name,
      //     img: this.data.tourSuggestions[i].image_url,
      //     file: '',
      //     url: this.data.tourSuggestions[i].url,
      //     status: this.data.tourSuggestions[i].status,
      //   })
      //   suggestions.push({
      //     name: this.data.tourSuggestions[i].name,
      //     image_url: this.data.tourSuggestions[i].image_url,
      //     url: this.data.tourSuggestions[i].url,
      //     status: this.data.tourSuggestions[i].status,
      //   })
      // }
    ...
    set_tour_type() {
      this.$store.dispatch('nha_cung_cap_san_pham/tour_type').then((res) => {
        if (!res.error) {
    ...
    set_tour_province() {
      this.$store
        .dispatch('nha_cung_cap_san_pham/tour_province')
        .then((res) => {
          if (!res.error) {
    ...
    set_tour_district() {
      this.$store
        .dispatch('nha_cung_cap_san_pham/tour_district')
        .then((res) => {
          if (!res.error) {
    ...
    //   const folder = 'tour-product-suggestions-img'
    //   const formData = new FormData()
    //   const index = []
    //   for (let i = 0; i < this.listsuggestions.length; i++) {
    //     if (!this.$isNullOrEmpty(this.listsuggestions[i].file)) {
    ...
    //               url: this.listsuggestions[i].url,
    ...
    insert() {
      ...
      this.$store
        .dispatch('nha_cung_cap_san_pham/tour_edit', DATA)
        .then((res) => {
          if (!res.error) {
            this.$showSuccess(this, 'Cập nhật sản phẩm tour thành công')
            this.$emit('toggle')
            this.$emit('success')
          }
        })
    ...
    get_review() {
      ...
      this.$store
        .dispatch('nha_cung_cap_san_pham/review_tour', DATA)
        .then((res) => {
          if (!res.error) {
