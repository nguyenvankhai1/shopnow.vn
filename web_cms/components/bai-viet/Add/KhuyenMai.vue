<template>
  <div class="main_big_promotion">
    ...
    <div class="ml-16">
      ...
      <div class="d-flex">
        <div class="fs-16 font-weight-bold mr-5 mt-4">Có thể bạn quan tâm</div>
        <v-switch
          v-model="status_care"
          inset
          color="#47bbff"
...
export default {
  ...
  data: (vm) => ({
    ...
    startDateError: [],
    endDateError: [],
    time_checkin: '06:59:59',
    time_checkout: '06:59:59',
    menuEnd: false,
    time_start: null,
    time_end: null,
  ...
  methods: {
    ...
    resetPromotion() {
      ...
      this.time_checkin = '06:59:59'
      this.time_checkout = '06:59:59'
      this.tab = null
      this.tab1 = null
      this.tab2 = null
    ...
    view_print_promotion_Print() {
      ...
      this.$store
        .dispatch('bai_viet/preview_post', {
          ...
          interested_status: this.status_care,
