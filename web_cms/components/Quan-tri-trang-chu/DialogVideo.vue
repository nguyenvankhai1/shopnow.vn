...
export default {
  ...
  methods: {
    updatePaused(event) {
      ...
      // const seekToTime = event.target.currentTime + event
      // if (seekToTime < 0 || seekToTime > event.target.duration) {
      //   return
      // }

      // event.target.currentTime = seekToTime
      // console.log(event.target.currentTime + event, '1')
    },
    // seekToTime(value) {
    //   console.log(value.target.currentTime, '1')
    // },
